...
const Employee = () => {
    ...
    useEffect(() => {
        if(isDemoMode){
            setEmployees([
                {id:1, name:"Dan Koh", email:"dankoh@gmail.com", adress:"Nairobi", salary: 15000, category:"Design"},
                {id:1, name:"Ann Jane", email:"annjane@gmail.com", adress:"Nakuru", salary: 200000, category:"IT"},
                {id:1, name:"Ang Kim", email:"angkim@gmail.com", adress:"Mombasa", salary: 18000, category:"Design"},
            ])
        }
        API.get("http://localhost:5000/auth/employee")
            .then(result => {
